...
Pregnancies = st.selectbox("Pregnancies",  min_value=0.0, max_value=17.0, value=0.0, step=0.1)
Glucose = st.selectbox("Glucose", min_value=0.0, max_value=199.0, value=.0, step=0.1)
